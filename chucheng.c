            ...
            if(('o'==flag[0])&&('n'==flag[1]))
            {
	         Clear_Display();
               ...
               // printf("\n=================================\n");
                ...
                FILE *fp=fopen(savePath,"ab+");
                fprintf(fp,"%s\n",maoliaohebanchengpin);
              //  for(ttt=0;ttt<30;ttt++)
              //  {
              //      printf("%c ",maoliaohebanchengpin[ttt]);
              //  }
                write_block_m1(1,0,init);
                write_block_m1(1,1,init);
                fclose(fp);  
                sync();
                //display_char();
		Clear_Display();
